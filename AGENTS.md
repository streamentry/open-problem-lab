...
- `public-health/long-distance-elder-care-vietnam` — consented care-response framing that separates monitoring, acknowledgement, physical reach, resolution, transfer, and clinical outcome; `playbooks-vietnamese.md` provides the Vietnamese operational translation while `playbooks.md` remains canonical
