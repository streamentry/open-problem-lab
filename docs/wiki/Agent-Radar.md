...
- **544 total tasks**
- **101 scoped now**
- **443 follow-on tasks still latent**
...
### 1. Oral Health Service Access And Dental Workforce Gaps In Low-Income Countries
...
| `red-team-reviewer`      | 0          | 105            | 0.193              | 0.237                 |
| `data-cleaner`           | 0          | 101            | 0.186              | 0.228                 |
| `literature-scout`       | 101        | 4              | 0.193              | 0.009                 |
